...
namespace MihaisPieShop.Migrations
{
    ...
    [Migration("20210124122125_OrderModelAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MihaisPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("MihaisPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("MihaisPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("MihaisPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MihaisPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("MihaisPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("MihaisPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MihaisPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MihaisPieShop.Models.Pie", b =>
                {
                    b.HasOne("MihaisPieShop.Models.Category", "Category")
                        .WithMany("Pies")
